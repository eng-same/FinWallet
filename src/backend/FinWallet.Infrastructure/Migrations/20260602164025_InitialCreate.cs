        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    UserId = table.Column<Guid>(type: "uuid", nullable: false),
                    WalletNumber = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Wallet_Balance_Min", "\"Balance\" >= 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Transaction_Amount_Min", "\"Amount\" > 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WalletStatusHistories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WalletStatusHistories_Users_ChangedByUserId",
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_WalletStatusHistories_Wallets_WalletId",
                        column: x => x.WalletId,
                        principalSchema: "wallet",
                        principalTable: "Wallets",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BankTopUpRequests", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BankTopUpRequests_Transactions_TransactionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_LedgerEntry_Amount_Min", "\"Amount\" > 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BankTopUpRequests_CorrelationId",
                schema: "integration",
                table: "BankTopUpRequests",
                column: "CorrelationId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_BankTopUpRequests_RequestNumber",
                schema: "integration",
                table: "BankTopUpRequests",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BankTopUpRequests_TransactionId",
                schema: "integration",
                table: "BankTopUpRequests",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WalletStatusHistories_ChangedByUserId",
                schema: "audit",
                table: "WalletStatusHistories",
                column: "ChangedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_WalletStatusHistories_WalletId",
                schema: "audit",
                table: "WalletStatusHistories",
                column: "WalletId");
        }
